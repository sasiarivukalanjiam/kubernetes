...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*KubeProxy)(nil), (*kubeadm.KubeProxy)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_KubeProxy_To_kubeadm_KubeProxy(a.(*KubeProxy), b.(*kubeadm.KubeProxy), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kubeadm.KubeProxy)(nil), (*KubeProxy)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kubeadm_KubeProxy_To_v1alpha3_KubeProxy(a.(*kubeadm.KubeProxy), b.(*KubeProxy), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*KubeletConfiguration)(nil), (*kubeadm.KubeletConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_KubeletConfiguration_To_kubeadm_KubeletConfiguration(a.(*KubeletConfiguration), b.(*kubeadm.KubeletConfiguration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kubeadm.KubeletConfiguration)(nil), (*KubeletConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kubeadm_KubeletConfiguration_To_v1alpha3_KubeletConfiguration(a.(*kubeadm.KubeletConfiguration), b.(*KubeletConfiguration), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*MasterConfiguration)(nil), (*kubeadm.MasterConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_MasterConfiguration_To_kubeadm_MasterConfiguration(a.(*MasterConfiguration), b.(*kubeadm.MasterConfiguration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kubeadm.MasterConfiguration)(nil), (*MasterConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kubeadm_MasterConfiguration_To_v1alpha3_MasterConfiguration(a.(*kubeadm.MasterConfiguration), b.(*MasterConfiguration), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*NodeConfiguration)(nil), (*kubeadm.NodeConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_NodeConfiguration_To_kubeadm_NodeConfiguration(a.(*NodeConfiguration), b.(*kubeadm.NodeConfiguration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kubeadm.NodeConfiguration)(nil), (*NodeConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kubeadm_NodeConfiguration_To_v1alpha3_NodeConfiguration(a.(*kubeadm.NodeConfiguration), b.(*NodeConfiguration), scope)
	}); err != nil {
		return err
	}
